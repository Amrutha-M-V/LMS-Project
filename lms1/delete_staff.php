...
$reason = $_GET['reason'];
$query = "SELECT * FROM user_info WHERE NOT user_id='$user_id'";
...
$total = mysqli_num_rows($data);
  ...
  if($total!=0)
  {
    ...
    <td width=\"200px\">".$result['user_id']."</td>
    <td width=\"200px\">".$result['gender']."</td>
    <td width=\"200px\">".$result['phone_no']."</td>
    <td width=\"200px\">".$result['branch']."</td>
    <td width=\"200px\">".$result['college']."</td>
    <td width=\"200px\">".$result['user_type']."</td>
    <td width=\"150px\">
      <form action='delete.php' method='post'>
        <input type='hidden' name='name' value='$result[name]'></input>
...
<?php
    ...
    if ($reason == "added")
        echo "<b style='color:green'>Record Deleted Successfully</b><br>";
    elseif($reason == "not")
        echo "<b style='color:red'>Record Not Deleted</b><br>";
?><br><br>
