...
<br><br>
  ...
  <?php
    ...
    elseif($reason == "invalid_leave")
        echo "<b style='color:red'> &nbsp&nbsp&nbsp giving same date Type</b><br>"; 
    elseif($reason == "invalid")
        echo "<b style='color:red'> &nbsp&nbsp&nbsp Invalid Leave Type</b><br>";
    elseif($reason == "invali")
        echo "<b style='color:red'> &nbsp&nbsp&nbsp Already Applied Type</b><br>";
